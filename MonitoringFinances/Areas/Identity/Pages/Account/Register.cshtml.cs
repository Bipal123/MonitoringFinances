...
namespace MonitoringFinances.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        private void Load()
        {
            AllRoles = _roleManager.Roles.Select(i => new SelectListItem
            {
                Text = i.Name,
                Value = i.Name
            });
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if (_signInManager.IsSignedIn(User) & User.IsInRole(WebConstant.AdminRole))
                    {
                        await _userManager.AddToRoleAsync(user, Input.AssignedRole);
                    }
                    else
                    {
